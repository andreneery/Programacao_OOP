...
public class GreetingServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            LocalTime manha = LocalTime.of(6, 0);
            LocalTime tarde = LocalTime.of(12, 0);
            LocalTime noite = LocalTime.of(18, 0);
            LocalTime madrugada = LocalTime.of(23, 0);

            if (horaAtual.isBefore(manha)) {
                out.println("Boa noite!");
            } else if (horaAtual.isBefore(tarde)) {
                out.println("Bom dia!");
            } else if (horaAtual.isBefore(noite)) {
                out.println("Boa tarde!");
            } else if(horaAtual.isBefore(madrugada)) {
                out.println("Boa noite!");
            } else{
                out.println("Vá Dormir!");
            }
            out.println("</body>");
            out.println("</html>");
        }
